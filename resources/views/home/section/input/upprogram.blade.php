    ...
    <div class="col-md-12">
       <div class="panel panel-info">
            <div class="panel-heading">
                <h3 class="panel-title">Pembuatan Program</h3>
            ...
            <div class="panel-body">
 	   			<div class=" col-md-6">
 	   				<form action="{{url('/home/keuangan/'.$cekdata->id_trans.'/editprogram')}}" method="post">
 	   				@csrf
 	   				@method('put')
 	   				<label for="nmkom">Nama</label>
 	   				<input type="text" name="nama" id="nmkom" value="{{$cekdata->nama}}" class="form-control">
 	   				<label for="jenis">Jenis Aplikasi</label>
 	   				<input type="text" name="keterangan" id="jenis" value="{{$cekdata->keterangan}}" class="form-control">
            <label for="nohp">No Hp.</label>
            <input type="number" name="nohp" id="nohp" value="{{$cekdata->nohp}}" class="form-control">
